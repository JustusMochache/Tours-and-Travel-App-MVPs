...
//    public static final String FROM_BUS = "firstlocation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items1 = new String[]{"FROM", "Kisumu", "Nairobi", };
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, items1);
        dropdown1.setAdapter(adapter1);

        //To
        Spinner dropdown2 = findViewById(R.id.spinner2);
        String[] items2 = new String[]{"TO", "Nairobi", "Kisumu", };
...
//
        getSupportActionBar().setTitle("Search for Car");
...
//        String key = databaseReference.push().getKey();
        ...
        if (TextUtils.equals(from, "FROM")) {
            //email is empty
            Toast.makeText(this, "Please select departure place", Toast.LENGTH_LONG).show();
            return;
        }
        if (TextUtils.equals(to, "TO")) {
            //password is empty
            Toast.makeText(this, "Please select destination place", Toast.LENGTH_LONG).show();
            return;
        }
        if (TextUtils.isEmpty(date)) {
            //password is empty
            Toast.makeText(this, "Please select journey date", Toast.LENGTH_LONG).show();
            return;
        }

        progressDialog.setMessage("Searching Cars Please Wait...");
        progressDialog.show();
...
//        startActivity(new Intent(getApplicationContext(), BusActivity.class));
        ...
        intent.putExtra("bus_images", date);
